...
typedef enum TileTerrain {
    ...
    TILE_TERRAIN_HIVE_INTERIOR = 4,
    TILE_TERRAIN_HIVE_STORAGE = 5,
    TILE_TERRAIN_HIVE_WALL = 6,
    TILE_TERRAIN_HIVE_ENTRANCE = 7,
    TILE_TERRAIN_FLOWERS = 8,
    TILE_TERRAIN_COUNT
} TileTerrain;
...
#define HEX_TERRAIN_HIVE_INTERIOR TILE_TERRAIN_HIVE_INTERIOR
#define HEX_TERRAIN_HIVE_STORAGE TILE_TERRAIN_HIVE_STORAGE
#define HEX_TERRAIN_HIVE_WALL TILE_TERRAIN_HIVE_WALL
#define HEX_TERRAIN_HIVE_ENTRANCE TILE_TERRAIN_HIVE_ENTRANCE
